 ...
 * on 2014-08-05 at 05:05:05 UTC 
 * Modify at your own risk.
 */

package com.codesdk.mobileassistant.offerendpoint;
...
public class Offerendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetOffer extends OfferendpointRequest<com.codesdk.mobileassistant.offerendpoint.model.Offer> {
    ...
    protected GetOffer(java.lang.String id) {
      super(Offerendpoint.this, "GET", REST_PATH, null, com.codesdk.mobileassistant.offerendpoint.model.Offer.class);
   ...
   *
   * @param content the {@link com.codesdk.mobileassistant.offerendpoint.model.Offer}
   * @return the request
   */
  public InsertOffer insertOffer(com.codesdk.mobileassistant.offerendpoint.model.Offer content) throws java.io.IOException {
    InsertOffer result = new InsertOffer(content);
    initialize(result);
    return result;
  }

  public class InsertOffer extends OfferendpointRequest<com.codesdk.mobileassistant.offerendpoint.model.Offer> {
     ...
     * @since 1.13
     */
    protected InsertOffer(com.codesdk.mobileassistant.offerendpoint.model.Offer content) {
      super(Offerendpoint.this, "POST", REST_PATH, content, com.codesdk.mobileassistant.offerendpoint.model.Offer.class);
    }
  ...
  public class ListOffer extends OfferendpointRequest<com.codesdk.mobileassistant.offerendpoint.model.CollectionResponseOffer> {
     ...
     */
    protected ListOffer() {
      super(Offerendpoint.this, "GET", REST_PATH, null, com.codesdk.mobileassistant.offerendpoint.model.CollectionResponseOffer.class);
    }
   ...
   * @return the request
   */
  public UpdateOffer updateOffer(com.codesdk.mobileassistant.offerendpoint.model.Offer content) throws java.io.IOException {
    UpdateOffer result = new UpdateOffer(content);
    initialize(result);
    return result;
  }

  public class UpdateOffer extends OfferendpointRequest<com.codesdk.mobileassistant.offerendpoint.model.Offer> {
     ...
     * @since 1.13
     */
    protected UpdateOffer(com.codesdk.mobileassistant.offerendpoint.model.Offer content) {
      super(Offerendpoint.this, "PUT", REST_PATH, content, com.codesdk.mobileassistant.offerendpoint.model.Offer.class);
    }
