...
package com.codesdk.mobileassistant.placeendpoint;
...
public class Placeendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetPlace extends PlaceendpointRequest<com.codesdk.mobileassistant.placeendpoint.model.Place> {
    ...
    protected GetPlace(java.lang.Long id) {
      super(Placeendpoint.this, "GET", REST_PATH, null, com.codesdk.mobileassistant.placeendpoint.model.Place.class);
   ...
   *
   * @param content the {@link com.codesdk.mobileassistant.placeendpoint.model.Place}
   * @return the request
   */
  public InsertPlace insertPlace(com.codesdk.mobileassistant.placeendpoint.model.Place content) throws java.io.IOException {
    InsertPlace result = new InsertPlace(content);
    initialize(result);
    return result;
  }

  public class InsertPlace extends PlaceendpointRequest<com.codesdk.mobileassistant.placeendpoint.model.Place> {
     ...
     * @since 1.13
     */
    protected InsertPlace(com.codesdk.mobileassistant.placeendpoint.model.Place content) {
      super(Placeendpoint.this, "POST", REST_PATH, content, com.codesdk.mobileassistant.placeendpoint.model.Place.class);
    }
  ...
  public class ListPlace extends PlaceendpointRequest<com.codesdk.mobileassistant.placeendpoint.model.CollectionResponsePlace> {
     ...
     */
    protected ListPlace() {
      super(Placeendpoint.this, "GET", REST_PATH, null, com.codesdk.mobileassistant.placeendpoint.model.CollectionResponsePlace.class);
    }
   ...
   * @return the request
   */
  public UpdatePlace updatePlace(com.codesdk.mobileassistant.placeendpoint.model.Place content) throws java.io.IOException {
    UpdatePlace result = new UpdatePlace(content);
    initialize(result);
    return result;
  }

  public class UpdatePlace extends PlaceendpointRequest<com.codesdk.mobileassistant.placeendpoint.model.Place> {
     ...
     * @since 1.13
     */
    protected UpdatePlace(com.codesdk.mobileassistant.placeendpoint.model.Place content) {
      super(Placeendpoint.this, "PUT", REST_PATH, content, com.codesdk.mobileassistant.placeendpoint.model.Place.class);
    }
