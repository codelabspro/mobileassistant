 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "codesdk.com", ownerName = "codesdk.com", packagePath="mobileassistant"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyC6Ij3E5lruA51O9qIvTpnmbeOVoxDiBrA";
